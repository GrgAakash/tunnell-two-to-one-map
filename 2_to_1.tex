...
established identity $|\Bn|=2|\An|$; more generally, the construction applies
...
representation numbers in this identity.  Our purpose is different.  We use
\eqref{eq:Tunnell-balance}, established by Tunnell for the congruent numbers
under consideration, and seek a structured map between the representations
that it counts.  Isolating the balance also gives a slightly more general
construction for any odd positive squarefree $n$ satisfying the same
identity.  We neither reprove Tunnell's identity nor propose a new
...
\begin{theorem}[Two-to-one map under the Tunnell balance]\label{thm:main}
